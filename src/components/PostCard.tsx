...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="max-w-xs rounded-lg border border-gray-200 bg-white shadow-md overflow-hidden p-4  dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 lg:mr-10">
